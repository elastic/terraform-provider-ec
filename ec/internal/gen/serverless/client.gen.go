...
// Valid indicates whether the value is a known member of the CSP enum.
func (e CSP) Valid() bool {
	switch e {
	case Aws:
		return true
	case Azure:
...
// Valid indicates whether the value is a known member of the ElasticsearchOptimizedFor enum.
func (e ElasticsearchOptimizedFor) Valid() bool {
	switch e {
	case GeneralPurpose:
		return true
	case Vector:
...
// Valid indicates whether the value is a known member of the ElasticsearchProjectType enum.
func (e ElasticsearchProjectType) Valid() bool {
	switch e {
	case ElasticsearchProjectTypeElasticsearch:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ElasticsearchProjectCreatedType enum.
func (e ElasticsearchProjectCreatedType) Valid() bool {
	switch e {
	case ElasticsearchProjectCreatedTypeElasticsearch:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ObservabilityProjectType enum.
func (e ObservabilityProjectType) Valid() bool {
	switch e {
	case ObservabilityProjectTypeObservability:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ObservabilityProjectCreatedType enum.
func (e ObservabilityProjectCreatedType) Valid() bool {
	switch e {
	case ObservabilityProjectCreatedTypeObservability:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ObservabilityProjectProductTier enum.
func (e ObservabilityProjectProductTier) Valid() bool {
	switch e {
	case ObservabilityProjectProductTierComplete:
		return true
	case ObservabilityProjectProductTierLogsEssentials:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the OptionalSecurityAdminFeaturesPackage enum.
func (e OptionalSecurityAdminFeaturesPackage) Valid() bool {
	switch e {
	case OptionalSecurityAdminFeaturesPackageEnterprise:
		return true
	case OptionalSecurityAdminFeaturesPackageStandard:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SecurityAdminFeaturesPackage enum.
func (e SecurityAdminFeaturesPackage) Valid() bool {
	switch e {
	case SecurityAdminFeaturesPackageEnterprise:
		return true
	case SecurityAdminFeaturesPackageStandard:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SecurityProductLine enum.
func (e SecurityProductLine) Valid() bool {
	switch e {
	case SecurityProductLineCloud:
		return true
	case SecurityProductLineEndpoint:
		return true
	case SecurityProductLineSecurity:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SecurityProductTier enum.
func (e SecurityProductTier) Valid() bool {
	switch e {
	case SecurityProductTierComplete:
		return true
	case SecurityProductTierEssentials:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SecurityProjectType enum.
func (e SecurityProjectType) Valid() bool {
	switch e {
	case SecurityProjectTypeSecurity:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SecurityProjectCreatedType enum.
func (e SecurityProjectCreatedType) Valid() bool {
	switch e {
	case Security:
		return true
	default:
...
type PatchElasticsearchProjectRequest struct {
	...
	SearchLake *OptionalElasticsearchSearchLake `json:"search_lake,omitempty"`
...
type PatchSecurityProjectRequest struct {
	...
	AdminFeaturesPackage *OptionalSecurityAdminFeaturesPackage `json:"admin_features_package,omitempty"`
...
func NewListTrafficFiltersRequest(server string, params *ListTrafficFiltersParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.IncludeByDefault != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "include_by_default", *params.IncludeByDefault, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
