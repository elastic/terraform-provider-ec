		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(sourceResName, "elasticsearch.0.topology.0.node_type_data", ""),
					resource.TestCheckResourceAttr(sourceResName, "elasticsearch.0.topology.0.node_type_ingest", ""),
					resource.TestCheckResourceAttr(sourceResName, "elasticsearch.0.topology.0.node_type_master", ""),
					resource.TestCheckResourceAttr(sourceResName, "elasticsearch.0.topology.0.node_type_ml", ""),
					resource.TestCheckResourceAttr(sourceResName, "elasticsearch.0.topology.0.id", "hot_content"),
					resource.TestCheckResourceAttrSet(sourceResName, "elasticsearch.0.topology.0.node_roles.#"),
