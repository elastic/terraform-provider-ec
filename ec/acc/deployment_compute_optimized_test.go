...
func TestAccDeployment_computeOptimized(t *testing.T) {
	...
	startCfg := "testdata/deployment_compute_optimized_1.tf"
	secondCfg := "testdata/deployment_compute_optimized_2.tf"
	cfg := fixtureAccDeploymentResourceBasicDefaults(t, startCfg, randomName, getRegion(), computeOpTemplate)
