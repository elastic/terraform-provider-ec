		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "apm.0.endpoint.#", "1"),
					resource.TestCheckResourceAttrSet(resName, "apm.0.endpoint.0.http"),
					resource.TestCheckResourceAttrSet(resName, "apm.0.endpoint.0.https"),
					...
					resource.TestCheckResourceAttr(resName, "elasticsearch.0.endpoint.#", "1"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.0.endpoint.0.http"),
					resource.TestCheckResourceAttrSet(resName, "elasticsearch.0.endpoint.0.https"),
					...
					resource.TestCheckResourceAttr(resName, "kibana.0.endpoint.#", "1"),
					resource.TestCheckResourceAttrSet(resName, "kibana.0.endpoint.0.http"),
					resource.TestCheckResourceAttrSet(resName, "kibana.0.endpoint.0.https"),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "appsearch.0.endpoint.#", "1"),
					resource.TestCheckResourceAttrSet(resName, "appsearch.0.endpoint.0.http"),
					resource.TestCheckResourceAttrSet(resName, "appsearch.0.endpoint.0.https"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.#", "1"),
					resource.TestCheckResourceAttr(resName, "elasticsearch.0.version", deploymentVersion),
					resource.TestCheckResourceAttr(resName, "elasticsearch.0.region", region),
					resource.TestCheckResourceAttr(resName, "elasticsearch.0.topology.0.memory_per_node", "1g"),
