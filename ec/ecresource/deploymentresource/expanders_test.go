	...
	tests := []struct {
		...
		// an error instead.
		{
			...
			err: multierror.NewPrefixed("invalid configuration",
				errors.New("kibana specified but deployment template does not allow it"),
				errors.New("apm specified but deployment template does not allow it"),
				errors.New("enterprise_search specified but deployment template does not allow it"),
			),
		},
	}
