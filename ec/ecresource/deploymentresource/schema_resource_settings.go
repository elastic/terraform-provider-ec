...
const (
	dockerImageKey = "docker_image"

	userSettingsJSONKey         = "user_settings_json"
	userSettingsOverrideJSONKey = "user_settings_override_json"
	userSettingsYAMLKey         = "user_settings_yaml"
	userSettingsOverrideYAMLKey = "user_settings_override_yaml"
)

func dockerImage() *schema.Schema {
...
func userSettingsJSON() *schema.Schema {
	return &schema.Schema{
		Type:        schema.TypeString,
...
func userSettingsOverrideJSON() *schema.Schema {
	return &schema.Schema{
		Type:        schema.TypeString,
...
func userSettingsYAML() *schema.Schema {
	return &schema.Schema{
		Type:        schema.TypeString,
...
func userSettingsOverrideYAML() *schema.Schema {
	return &schema.Schema{
		Type:        schema.TypeString,
